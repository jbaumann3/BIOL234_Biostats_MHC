---
title: 'BMSS R Tutorial 2: Data manipulation and using Tidyverse'
...
![](/home/jbaumann/BMSS/images/tidyverse_cheat_sheet.png)
...
2.) Pull a dataset from online ([tidytuesday](https://github.com/rfordatascience/tidytuesday/tree/master/data)) or use a preloaded dataset in R 
  ...
  a.) Select columns to keep / remove
  b.) Filter your data to include only some levels of a factor (for example, include only 1 of 3 species or something)
  c.) Add a new column! You can use column math for this if you'd like (multiple stuff together, change the unit, etc)
  d.) Try to pivot your data from long to wide (or wide to long) and then return it back to its orignal format!
  
3.) Use a pipe group and calculate means!
