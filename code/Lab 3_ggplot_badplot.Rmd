---
title: 'Lab 3 - ggplot and data visualization'
...
![](/home/jbaumann/BIOL234_Biostats_MHC/images/ggplot cheat sheet 1.png)
![](/home/jbaumann/BIOL234_Biostats_MHC/images/ggplot cheat sheet 2.png)
...
![ggplot shape options](/home/jbaumann/BIOL234_Biostats_MHC/images/ggplot_shapes.png)
...
![ggplot color options](/home/jbaumann/BIOL234_Biostats_MHC/images/ggplot_colors.png)
...
1.) Grab some data (check out TidyTuesday) and make a boxplot, bar plot, histogram, and scatter plot </br>
2.) Calculate a mean and plot mean + error </br>
3.) Try facets, changing shapes, sizes, and customizing colors and themes </br>
4.) Recall our class discussion and readings about data visualization. Write two ways in which plots can be good (clear) and two ways in which plots can be bad (unclear). 
5.) Think of a research question or field that you work in or are interested in. Using a quick google scholar search, identify an example of a good plot and a bad plot within that field. Screenshot your plots and share them in your Rmarkdown document. Explain briefly why each plot is "good" or "bad."
6.) Using your data from before, create the worst possible plot you can make (consider the many ways in which [theme()](https://ggplot2.tidyverse.org/reference/theme.html) can be used in ggplot!). Explain why your bad plot is bad. 
7.) Now, make a 'good' version of the same plot and explain how and why this is better. PLot your two graphs as a two panel figure using patchwork. 

*NOTE* You do not need to make the most amazing or the most terrible plots ever, but you are welcome to explore as much as you would like. As long as you can demonstrate the concepts of good/bad data visualization and show your understanding of these concepts you will get full credit. That said, one of the best ways to learn R is to try new things, so challenge yourself if you have the time and energy to do so. Remember, I am happy to help!
