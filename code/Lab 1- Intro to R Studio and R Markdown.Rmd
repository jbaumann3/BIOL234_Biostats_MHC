...
10.) When you are done, you can turn in your finished .RMD document on Moodle! Reminder that GitHub is for version control and you all have your own repositories. I can techincally access them if you set them to public but I would need your username or a link to find them. To make everything easier for everyone, just download your .rmd and .html/.pdf output files and turn them in on Moodle. We will turn in and receive grades/feedback for ALL assignments via Moodle. 
